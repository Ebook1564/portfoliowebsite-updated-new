...
import { Layout, Zap, TrendingUp, CheckCircle2, Rocket, Globe, ShieldCheck, Gamepad2, Users } from "lucide-react"
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-blue-400 text-sm font-black tracking-[0.2em] uppercase">Maximize Your Revenue</span>
                            </motion.div>
                ...
                {/* Publisher Solutions Section - Light Theme Reveal */}
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="text-center max-w-3xl mx-auto mb-20">
                            ...
                            <motion.p
                                ...
                                viewport={{ once: true }}
                            >
                                Designed to maximize user LTV and engagement with a seamless, high-performance integration.
                            </motion.p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "Access premium rewarded video, interstitials, and native units to drive maximum revenue without breaking the user experience.",
                                    icon: TrendingUp,
                                    stats: "45% Revenue Boost",
                                    color: "indigo"
                                },
                                {
                            ...
                            <div className="md:w-1/2">
                                ...
                                >
                                    ...
                                    <p className="text-xl text-blue-100/70 mb-10 leading-relaxed max-w-lg font-medium">
                                        We provide the infrastructure and content to turn your platform into a high-performance gaming hub.
                                    </p>
                                ...
                                >
                                    ...
                                    <div className="space-y-6">
                                        {[
                                            ...
                                            "AI-driven yields for maximum revenue",
                                            "Brand safety and content filtering",
                                            "Detailed real-time performance analytics"
                                        ].map((point, i) => (
                                            <motion.div
                                                key={i}
                        ...
                        >
                            <div className="relative bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[4rem] p-12 md:p-20 overflow-hidden shadow-2xl text-center text-white">
                                ...
                                <h2 className="text-5xl md:text-7xl font-black mb-8 tracking-tighter leading-tight">
                                    ...
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">Game Platform?</span>
                                </h2>
