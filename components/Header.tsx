        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Link
                href="/enquire"
                className="px-6 py-2.5 bg-white text-[#020617] font-black uppercase tracking-widest text-xs rounded-xl hover:bg-blue-500 hover:text-white transition-all duration-300 shadow-xl"
              >
                Enquire now
              </Link>
            </motion.div>
            ...
            <div className="px-6 py-8 space-y-2">
              ...
              >
                <Link
                  href="/enquire"
                  onClick={() => setIsOpen(false)}
                  className="block w-full py-5 bg-blue-600 text-white rounded-[1.5rem] font-black uppercase tracking-[0.2em] text-center text-sm shadow-2xl shadow-blue-500/20 hover:bg-blue-500 transition-all active:scale-95"
                >
                  Enquire Now
                </Link>
              </motion.div>
